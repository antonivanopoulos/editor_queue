defmodule EditorQueueWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule EditorQueue.MyChannel do
        use EditorQueueWeb, :channel
        alias EditorQueue.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :editor_queue,
                        pubsub_server: EditorQueue.PubSub
end
